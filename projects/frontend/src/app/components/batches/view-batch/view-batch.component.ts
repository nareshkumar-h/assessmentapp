...
export class ViewBatchComponent implements OnInit {
  ...
  constructor(private batchService:BatchService,private courseService:CourseService,  private router:Router, private route:ActivatedRoute) { 
  ...
  loadMenus(){
    ...
    this.menus.push( {title: "Batch",  path:["../" + this.batchId], icontype:"fas fa-home", access: true});
    ...
    this.menus.push( {title: "Slack",  path:["slack"], icontype:"fab fa-slack", access: true});
