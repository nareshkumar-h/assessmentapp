...
export class SlackComponent implements OnInit {
  ...
  constructor(private slackService: SlackService, private authService:AuthService, private router:Router,private route:ActivatedRoute, private toastr:ToastrService) {
