...
export class ProjectMainSidebarComponent implements OnInit {
  ...
  loadMenus(){
    ...
    this.menus.push( {title: "My Projects",  path:["../../projects"], icontype:"fas fa-user", access: this.authService.hasRoleAccess(["U"])});
    this.menus.push( {title: "All Projects",  path:[ "../projects/all"], icontype:"fas fa-laptop", access:this.authService.hasRoleAccess(["U","T","HR"])});    
    ...
    this.menus.push( {title: "Reports",  path:[ "../../reports/projects"], icontype:"fas fa-tasks", access: this.authService.hasRoleAccess(["T","HR"])});      
  }
