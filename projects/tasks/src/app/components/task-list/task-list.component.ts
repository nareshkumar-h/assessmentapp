...
export class TaskListComponent implements OnInit {
  ...
  constructor(private courseService:CourseContentService,  private router: Router, 
  ...
  findUserCourseContents(){
    console.log("Fetching User course contents:", this.userId + "," + this.courseId);
  ...
  loadMenus(){
    this.menus = [];
    this.menus.push( {title: "Java",  path:["/tasks/java"], icontype:"fas fa-home",  access: true});
    this.menus.push( {title: "HTML",  path:["/tasks/html"], icontype:"fas fa-task",  access: true});  
  }
