...
@Component({
  selector: 'lib-user-feature-rating-report',
  templateUrl: './user-feature-rating-report.component.html',
  styleUrls: ['./user-feature-rating-report.component.css']
})
export class UserFeatureRatingReportComponent implements OnInit {
