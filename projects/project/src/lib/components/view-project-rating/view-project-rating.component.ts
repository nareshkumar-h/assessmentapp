...
isMentor:boolean;
  ...
  displayedColumns: string[] = ['id','name','createdBy','count','functionality','design','bestPractices','timeline','complexity','action'];
  ...
  public doFilter = (value: string) => {
    ...
    this.projects = this.projects.filter(obj => obj.project.createdBy.indexOf(value) !=-1);
