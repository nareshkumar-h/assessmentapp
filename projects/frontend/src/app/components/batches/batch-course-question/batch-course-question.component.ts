...
import { KtClientService } from 'projects/knowledgetracker/src/app/kt-client.service';

@Component({
  selector: 'app-batch-course-question',
  templateUrl: './batch-course-question.component.html',
  styleUrls: ['./batch-course-question.component.css']
})
export class BatchCourseQuestionComponent implements OnInit {
